 ...
 *
 * Return: If the list is nt looped - 0, otherwise - the
...
/**
 * free_listint_safe - frees a listint_t list safely (i.e can free
 * lists containing loops)
 * @h: A pointer to the address of the head of the listint_t list.
 * Return: The size of the list that was freed
 *
 * Description: The fucntion set the head to NULL
 */
size_t free_listint_safe(listint_t **h)
{
	listint_t *tmp;
